...
class VacationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacation" do
    assert_difference('Vacation.count') do
      post vacations_url, params: { vacation: { budget: @vacation.budget, end_date: @vacation.end_date, location: @vacation.location, start_date: @vacation.start_date } }, as: :json
    end
  ...
  test "should update vacation" do
    patch vacation_url(@vacation), params: { vacation: { budget: @vacation.budget, end_date: @vacation.end_date, location: @vacation.location, start_date: @vacation.start_date } }, as: :json
    assert_response 200
  end
